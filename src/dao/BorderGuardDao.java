...
public class BorderGuardDao {
	...
	private void insertDummyDataToStateAdminUnit() {
		executeUpdate("INSERT INTO STATE_ADMIN_UNIT " +
						...
						"VALUES " +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU01', 'Kassi', '', '2012-12-01', '2999-12-31', 1)," +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU02', 'Toku', '', '2012-12-01', '2999-12-31', 1)," +
		
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU03', 'Londi', '', '2012-12-01', '2999-12-31', 1)," +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU04', 'Lusti', '', '2012-12-01', '2999-12-31', 1)," +
		
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'VA01', 'Urvaste', '', '2012-12-01', '2999-12-31', 2)," +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'VA02', 'Karula', '', '2012-12-01', '2999-12-31', 2)," +
		
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KI01', 'Urvaste', '', '2012-12-01', '2999-12-31', 3)," +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KI02', 'Karula', '', '2012-12-01', '2999-12-31', 3)," +
		
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'MA01', 'Voru', '', '2012-12-01', '2999-12-31', 4)," +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'RI01', 'Eesti', '', '2012-12-01', '2999-12-31', 5)" 
					);
	}
