...
public class BorderGuardDao {
	...
	private void insertDummyDataToStateAdminUnitType() {
		executeUpdate("INSERT INTO STATE_ADMIN_UNIT_TYPE " +
						...
						"VALUES " +
						"('admin', '2012-12-01', 'admin', '2012-12-01', '', '2999-12-31', 'KU', 'Kula', '', '2012-01-01', '2999-12-31')," +
	...
	private void insertDummyDataToStateAdminUnit() {
		executeUpdate("INSERT INTO STATE_ADMIN_UNIT " +
						...
						"VALUES " +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU01', 'Kassi kula', '', '2012-12-01', '2999-12-31', 1)," +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU02', 'Toku kula', '', '2012-12-01', '2999-12-31', 1)," +
		
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU03', 'Londi kula', '', '2012-12-01', '2999-12-31', 1)," +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU04', 'Lusti kula', '', '2012-12-01', '2999-12-31', 1)," +
