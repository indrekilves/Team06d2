...
public class BorderGuardDao {
	...
	private void insertDummyDataToStateAdminUnitType() {
		executeUpdate("INSERT INTO STATE_ADMIN_UNIT_TYPE " +
						...
						"VALUES " +
						"('admin', '2012-12-01', 'admin', '2012-12-01', '', '2999-12-31', 'KÜ', 'Küla', '', '2012-01-01', '2999-12-31')," +
	...
	private void insertDummyDataToStateAdminUnit() {
		executeUpdate("INSERT INTO STATE_ADMIN_UNIT " +
						...
						"VALUES " +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU01', 'Kassi küla', '', '2012-12-01', '2999-12-31', 1)," +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU02', 'Toku küla', '', '2012-12-01', '2999-12-31', 1)," +
		
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU03', 'Londi küla', '', '2012-12-01', '2999-12-31', 1)," +
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'KU04', 'Lusti küla', '', '2012-12-01', '2999-12-31', 1)," +
						...
						"('admin','2012-12-01' , 'admin', '2012-12-01', '','2999-12-31' , 'MA01', 'Võru maakond', '', '2012-12-01', '2999-12-31', 4)," +
